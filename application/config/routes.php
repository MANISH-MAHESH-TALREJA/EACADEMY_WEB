...
$route['end_metting/(:any)'] = 'admin_profile/end_jetsi_metting/$1';
$route['teacher-end-metting/(:any)'] = 'teacher_profile/end_jetsi_metting/$1';
...
$route['edit_paper_manage/(:any)'] = 'admin_profile/edit_paper_manage/$1';
...
$route['teacher/student-details/(:any)'] = 'teacher_profile/student_details/$1';
...
$route['plan-expired'] = 'student_profile/plan_expired';
...
$route['jetsi-meeting'] = 'admin_profile/JetsiMeeting';
$route['teacher-jetsi-meeting'] = 'teacher_profile/JetsiMeeting';
