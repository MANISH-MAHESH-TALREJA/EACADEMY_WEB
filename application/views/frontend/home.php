                    ...
                    <div class="swiper-slide">
                        <div class="innerSliderWrap">
                            <div class="edu_banner_section"
                                 style="background-image:url(<?php echo !empty($sliders['slider_img'][$i]) ? base_url('uploads/site_data/') . $sliders['slider_img'][$i] : base_url('uploads/site_data/') . 'assets/images/slider1.png'; ?>)">
                    ...
                    <div class="edu_callToAction_bg_inner">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12 p-0 text-center">
                            <div class="edu_action_section counter_item">
                                ...
                                <h1><span class="count_no"
                                          data-to="<?php echo !empty($frontend_details[0]['total_toppers']) ? $frontend_details[0]['total_toppers'] : '654'; ?>"
                                          data-speed="3000"><?php echo !empty($frontend_details[0]['total_toppers']) ? $frontend_details[0]['total_toppers'] : '654'; ?></span><span>+</span>
                                </h1>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12 p-0 text-center">
                            <div class="edu_action_section counter_item center">
                                ...
                                <h1><span class="count_no"
                                          data-to="<?php echo !empty($frontend_details[0]['trusted_students']) ? $frontend_details[0]['trusted_students'] : '156'; ?>"
                                          data-speed="3000"><?php echo !empty($frontend_details[0]['trusted_students']) ? $frontend_details[0]['trusted_students'] : '156'; ?></span><span>+</span>
                                </h1>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12 p-0 text-center">
                            <div class="edu_action_section counter_item">
                                ...
                                <h1><span class="count_no"
                                          data-to="<?php echo !empty($frontend_details[0]['years_of_histry']) ? $frontend_details[0]['years_of_histry'] : '18'; ?>"
                                          data-speed="3000"><?php echo !empty($frontend_details[0]['years_of_histry']) ? $frontend_details[0]['years_of_histry'] : '18'; ?></span><span>+</span>
                                </h1>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="edu_about_img relative mb_30">
                    <img class="edu_about_big_img parallax"
                         src="<?php echo !empty($frontend_details[0]['abt_frst_img']) ? base_url('uploads/site_data/') . $frontend_details[0]['abt_frst_img'] : base_url('uploads/site_data/') . 'assets/images/about_img1.png'; ?>"
                         alt=""/>
                    <img class="edu_about_small_img parallax"
                         src="<?php echo !empty($frontend_details[0]['abt_sec_img']) ? base_url('uploads/site_data/') . $frontend_details[0]['abt_sec_img'] : base_url('uploads/site_data/') . 'assets/images/about_img2.png'; ?>"
                         alt=""/>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="edu_about_detail mb_30">
                    <h4 class="edu_subTitle"><?php $hh = html_escape($this->common->languageTranslator('ltr_about_eacademy'));
                        echo !empty($frontend_details[0]['abt_frst_sub_heading']) ? $frontend_details[0]['abt_frst_sub_heading'] : $hh; ?></h4>
                    <h2 class="edu_heading"><?php $hhd = html_escape($this->common->languageTranslator('ltr_home_thousands'));
                        echo !empty($frontend_details[0]['abt_frst_heading']) ? $frontend_details[0]['abt_frst_heading'] : $hhd; ?></h2>
                    <p class="mb-3"><?php $hhdt = html_escape($this->common->languageTranslator('ltr_home_text'));
                        echo !empty($frontend_details[0]['abt_frst_desc']) ? $frontend_details[0]['abt_frst_desc'] : $hhdt; ?></p>
                    <a href="<?php echo base_url('about-us'); ?>"
                       class="edu_btn"><?php echo html_escape($this->common->languageTranslator('ltr_read_more')); ?></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                <div class="edu_heading_wrapper">
                    ...
                    <h4 class="edu_heading"><?php $hhdg = html_escape($this->common->languageTranslator('ltr_our_facilities'));
                        echo !empty($frontend_details[0]['faci_heading']) ? $frontend_details[0]['faci_heading'] : $hhdg; ?></h4>
        ...
        <section class="edu_selection_wrapper edu_selection_wrapper_res">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                        <div class="edu_heading_wrapper">
                            <h4 class="edu_subTitle"><?php $top = html_escape($this->common->languageTranslator('ltr_toppers_here'));
                                echo !empty($frontend_details[0]['selectn_subheading']) ? $frontend_details[0]['selectn_subheading'] : $top; ?></h4>
                            <h4 class="edu_heading"><?php $topd = html_escape($this->common->languageTranslator('ltr_our_selections'));
                                echo !empty($frontend_details[0]['selectn_heading']) ? $frontend_details[0]['selectn_heading'] : $topd; ?></h4>
                            <img class="border_images" src="<?php echo base_url(); ?>assets/images/border.png" alt=""/>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="edu_selection_section">
                                                        ...
                                                        <div class="edu_selection_section_inner">
                                                            <?php echo !empty($student_d[0]['image']) ? '<img src="' . base_url('uploads/students/') . $student_d[0]['image'] . '" alt=""  style="object-fit: fill"/>' : ''; ?>
                                                            <div class="edu_selection_info">
                                                                <a href="javascript:void(0);">
                                                                    <h4><?= $student_d[0]['name'] ?></h4></a>
                                                                <p><?php echo $ltr_designation; ?>
...
<section class="edu_courses_wrapper edu_courses_wrapper_res edu_courses_main">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                <div class="edu_heading_wrapper">
                    <h4 class="edu_subTitle"><?php $ltr_enhance = html_escape($this->common->languageTranslator('ltr_enhance'));
                        echo !empty($frontend_details[0]['sec_crse_sub_heading']) ? $frontend_details[0]['sec_crse_sub_heading'] : $ltr_enhance; ?></h4>
                    <h4 class="edu_heading white"><?php $ltr_our_courses = html_escape($this->common->languageTranslator('ltr_our_courses'));
                        echo !empty($frontend_details[0]['sec_crse_heading']) ? $frontend_details[0]['sec_crse_heading'] : $ltr_our_courses; ?></h4>
                    <img class="border_images" src="<?php echo base_url(); ?>assets/images/border.png" alt=""/>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="edu_team_section">
                                                <div class="edu_team_img">
                                                    <img src="<?php echo base_url('uploads/teachers/') . $teach_r['teach_image']; ?>"
                                                         alt="<?php echo html_escape($teach_r['name']); ?>" style="object-fit: fill"/>
                                                </div>
