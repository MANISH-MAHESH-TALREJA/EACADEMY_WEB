<!----- Page Title Start ----->
		...
		<section class="edu_contact_wrapper edu_contact_wrapper1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-12 text-center">
						<div class="edu_contact_section edu_contact_section_color">
							<div class="edu_contact_section_inner">
							    <div class="edu_contact-icon"><i class="icofont-ui-dial-phone"></i></div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-12 text-center">
						<div class="edu_contact_section edu_contact_section_color">
							<div class="edu_contact_section_inner">
								<div class="edu_contact-icon"><i class="icofont-map-pins"></i></div>
								<h4><?php echo html_escape($this->common->languageTranslator('ltr_our_location'));?></h4>
								<?php
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-12 text-center">
						<div class="edu_contact_section edu_contact_section_color">
							<div class="edu_contact_section_inner">
							    <div class="edu_contact-icon"><i class="icofont-email"></i></div>
		...
		<section class="edu_form_wrapper enroll-wrapper contactpage">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 p-0">
						<div class="edu_form_container_main edu_form_container <?php echo (empty($frontend_details[0]['map_api']))?'withoutMapFrm':'';?>">
