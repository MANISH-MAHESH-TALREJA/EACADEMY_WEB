                ...
                <?php if($status == 'update'){ ?>
                     ...
                     <tr>
                        <td>
                           ...
                           <p style="margin: 0;font-size:16px; color:#58616b;font-weight: 400; text-align:left;padding: 10px 50px 10px;">
                             <?php if($status=='Reset'){echo "Congratulations! We have  Reset Password your account on '.$site_Name.' Area . Please login using below link.";}elseif($status=='Update'){echo "Congratulations! We have Update You Course";}else{echo "Congratulations! We have  created your account on $site_Name. Please login using below link.";}?>
                           </p>
