...
<body>
      <div class="container">
        <!--<div id="navbar" class="websdktest">--> 
            <form class="navbar-form navbar-right" id="meeting_form">
                ...
                <div class="form-group">
                    <input type="hidden" name="display_email" id="display_email" value="<?=$email;?>" maxLength="100"
                        placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_name'));?>" class="form-control" required>
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript" src="<?=base_url();?>assets/js/zoom/client-view.js"></script>
...
<body>
    ...
    <input type="hidden" value="<?php echo base_url();?>student/dashboard<?php echo $inser_id; ?>" id="leaveurl" >
    <input type="hidden" value="" id="signature" >
    <input type="hidden" value="<?php echo $sdk_key;?>" id="SDK_key" >
    <input type="hidden" value="<?php echo $sdk_secret;?>" id="SDK_secret" >
