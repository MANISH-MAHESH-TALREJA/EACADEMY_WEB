				...
				<div class="edu_contact_form_wrapper edu_from_wrapper">
					<div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 edu_bottom_20">
                            <div class="form-group">
                                <label><?php echo html_escape($this->common->languageTranslator('ltr_whatsapp'));?></label>
                                <input type="text" class="form-control" name="whatsapp" value="<?php echo html_escape($contact_Details['0']['whatsapp']);?>" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_whatsapp'));?>" data-valid="url" data-error="Please use http or https in URL." data-symb="no">
                            </div>
                        </div>
						<div class="col-lg-12 col-md-12 col-sm-12 col-12 edu_bottom_20">
						    <div class="form-group">
