						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							    <div class="form-group">
									...
									<textarea rows="3" class="form-control description require" id="description" name="description"  placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_description'));?>"><?php echo !empty($privacypolicy)?$privacypolicy['0']['description']:'';?></textarea>
								</div>
							</div>
